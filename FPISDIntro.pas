   ...
   //===========================================
    ...
    //=========================
      ...
      case ComboBox1.itemindex of
        ...
        2 : begin FPISDMainMenuForm.Label80.Caption := 'PIÑAN';     FPISDMainMenuForm.Label81.Caption := 'AREA OFFICE';    end;
  ...
  case combobox1.ItemIndex of
    ...
    2 : begin
          try
            ...
            MessageDlg('PIÑAN AREA OFFICE OFFLINE..', mtWarning, [mbOK], 0);
          end;
        end;
    3 : begin
         try
