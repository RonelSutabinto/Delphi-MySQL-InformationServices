...
uses
  ...
  CRDBGrid1, AdvSmoothButton, frxClass, frxDBSet;
     ...
     With ISDData do
      begin
        ...
        begin
          ...
          NxHeaderPanel14.Caption := 'Consumer Priority Number (Piñan Area)';
...
procedure TFPISDMainMenuForm.AdvOfficeCheckBox1Click(Sender: TObject);
begin
...
begin
   ...
   isoComplaintsQ2.Open;
    ...
    begin
      ...
      complaintsreport2.sql.Add('and actiontaken is not null order by idcomplaints');
      ...
      //PeriodCovered.Caption     := 'Period Covered : '+ datetostr(DateTimeFrom.Date) + ' - ' + datetostr(DateTimeTo.Date);
      //QuickRep2.PreviewWidth    := Screen.Width;
      //QuickRep2.PreviewHeight   := Screen.Height;
      //QuickRep2.Preview;

      //FormatDateTime('m/d/yyyy',tmpQ.FieldByName('ORDate').AsDateTime);
    ...
    begin
      ...
      begin
          ...
          complaintsreport2.sql.Add(' complaint = :complaint and actiontaken is not null order by idcomplaints');
...
begin
  case tabset1.tabindex of
   ...
   datetimeFrom.DateTime:= StartOfTheMonth(Now);
   datetimeTo.DateTime:= EndOfTheMonth(Now);
...
begin
  ...
  ISDData.complaints.Filtered := not ISDData.complaints.Filtered;
  ...
  If ISDData.complaints.Filtered = true then
    begin
       NxLinkLabel13.Caption := 'View Pending Complaints - On';
       ISDData.complaints.FilterSQL := 'accomplished like '+quotedstr('0')+ ' and '+ isuedStr;
    end
    else
    begin
       NxLinkLabel13.Caption := 'View Pending Complaints - Off';
       ISDData.complaints.FilterSQL := isuedStr;
    end;
  ISDData.complaints.Open;
end;
